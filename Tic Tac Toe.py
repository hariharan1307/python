...
def GameOver():
    ...
    if (Board[1] == "x" and Board[2] == "x" and Board[3] == "x") or (
            ...
            Board[7] == "x" and Board[8] == "x" and Board[9] == "x"):
    ...
    # Vertical condtions
        ...
        return End
    # Diagonal conditions
    elif (Board[1] == "x" and Board[5] == "x" and Board[9] == "x") or (
    ...
    # Horizontal Conditions for player two
        ...
        return End
    # Vertical condtions
    elif (Board[1] == "o" and Board[4] == "o" and Board[7] == "o") or (
        ...
        return End
    # Diagonal conditions
    elif (Board[1] == "o" and Board[5] == "o" and Board[9] == "o") or (
